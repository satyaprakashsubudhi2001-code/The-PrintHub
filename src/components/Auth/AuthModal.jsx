...
export function AuthModal() {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 backdrop-blur-md animate-in fade-in select-none">
      <div className="relative w-full max-w-md bg-studio-900 border border-slate-700/80 rounded-3xl shadow-2xl overflow-hidden flex flex-col max-h-[90vh]">
        {/* =========================================================================
        ...
        <div className="p-6 overflow-y-auto space-y-5">
          ...
          {currentUser ? (
              ...
              <div className="space-y-5 animate-in fade-in">
                ...
                <div className="relative p-5 rounded-3xl bg-gradient-to-br from-indigo-900 via-slate-900 to-studio-950 border border-indigo-500/40 shadow-glow-primary overflow-hidden">
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <span className="px-2 py-0.5 rounded-md bg-indigo-500/20 text-[10px] font-bold text-indigo-300 border border-indigo-500/30">
                      Active Balance
                    </span>
                  </div>
                  ...
                  <div className="mt-4 flex items-center gap-2">
                    <button
                      ...
                      className={`flex-1 flex items-center justify-center gap-1.5 py-2.5 rounded-xl bg-gradient-to-r ${currentTheme.gradient} text-white text-xs font-black shadow-md hover:scale-102 transition-all`}
                    >
                    ...
                    <button
                      ...
                      className="px-3.5 py-2.5 rounded-xl bg-slate-800 hover:bg-slate-700 text-slate-200 text-xs font-semibold border border-slate-700 transition-all"
                    >
                      Coupons
                    </button>
                  </div>
                  ...
                  <div className="space-y-1.5 max-h-44 overflow-y-auto pr-1">
                    {savedDesigns && savedDesigns.length > 0 ? (
                      savedDesigns.map((des) => (
                        <div
                          key={des.id}
                          className="p-2.5 rounded-xl bg-slate-900 border border-slate-800/80 flex items-center justify-between gap-2.5 text-xs group"
                        >
                          <div className="flex items-center gap-2.5 min-w-0">
                            <img
                              src={des.previewImage}
                              alt={des.name}
                              className="w-9 h-9 object-cover rounded-lg bg-slate-950 p-0.5 border border-slate-700/60 shrink-0"
                            />
                            <div className="min-w-0">
                          ...
                          <div className="flex items-center gap-1.5">
                            <button
                              ...
                              className="px-2.5 py-1 rounded-lg bg-indigo-500/20 text-indigo-300 hover:bg-indigo-500/30 text-[10px] font-bold transition-all"
                            >
                              Edit
                            </button>
                            <button
              ...
              <div className="space-y-5 animate-in fade-in">
                <div className="text-center space-y-1">
                  <div className="w-12 h-12 rounded-2xl bg-indigo-500/20 text-indigo-400 border border-indigo-500/30 flex items-center justify-center mx-auto shadow-glow-primary">
                ...
                <div className="p-3 rounded-2xl bg-amber-500/10 border border-amber-500/30 flex items-center justify-between">
                  ...
                  <button
                    ...
                    className="px-2 py-1 rounded-lg bg-amber-500 text-black text-[10px] font-black"
                  >
                    Auto Fill
                  </button>
                </div>
                ...
                <form onSubmit={handleVerifyOtp} className="space-y-4">
                  <div>
                    <input
                      ...
                      placeholder="• • • • • •"
                      className="w-full px-4 py-3.5 rounded-2xl bg-slate-950 border border-slate-700 text-center text-2xl font-mono tracking-[0.6em] text-white focus:outline-none focus:border-indigo-500 shadow-inner font-black"
                      autoFocus
                      required
                    />
                  </div>
                  ...
                  <div className="flex items-center justify-between text-xs text-slate-400">
                    ...
                    <button
                      ...
                      className="text-indigo-400 hover:text-indigo-300 font-semibold disabled:opacity-40 disabled:hover:text-indigo-400"
                    >
                      Resend OTP
                    </button>
                  </div>
                  ...
                  <button
                    type="submit"
                    className={`w-full py-3.5 rounded-2xl bg-gradient-to-r ${currentTheme.gradient} ${currentTheme.glow} text-white text-xs font-black flex items-center justify-center gap-2 shadow-lg transition-all hover:scale-102`}
                  >
              ...
              <form onSubmit={handleSendOtp} className="space-y-4 animate-in fade-in">
                ...
                <div className="p-3.5 rounded-2xl bg-gradient-to-r from-amber-500/15 via-indigo-500/15 to-cyan-500/15 border border-amber-500/30 flex items-center gap-3">
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full pl-10 pr-4 py-2.5 rounded-xl bg-slate-950 border border-slate-700 text-xs text-white focus:outline-none focus:border-indigo-500"
                    />
                  </div>
                </div>
                ...
                {authMethod === 'mobile' ? (
                  <div>
                    ...
                    <div className="flex gap-2">
                      <span className="px-3 py-2.5 rounded-xl bg-slate-950 border border-slate-700 text-xs font-bold text-slate-300 flex items-center">
                        +91
                      </span>
                      <input
                        type="tel"
                        ...
                        className="flex-1 px-3.5 py-2.5 rounded-xl bg-slate-950 border border-slate-700 text-xs text-white focus:outline-none focus:border-indigo-500 font-mono"
                        required
                      />
                    </div>
                  </div>
                ...
                <button
                  type="submit"
                  className={`w-full py-3.5 rounded-2xl bg-gradient-to-r ${currentTheme.gradient} ${currentTheme.glow} text-white text-xs font-black flex items-center justify-center gap-2 shadow-lg transition-all hover:scale-102 mt-2`}
                >
